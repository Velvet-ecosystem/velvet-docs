...
This directory preserves how outside research, systems, theories, internal constraints, and convergent ideas are translated into Velvet architecture without erasing attribution, limitations, or the difference between a source claim and a Velvet decision.
...
## Archive-Dusting Backfill

Earlier Velvet work often preserved the finished doctrine but not the route by which the idea formed.

The backfill begins here:

1. [Research Provenance Backfill Ledger](provenance_backfill_ledger.md)
   - defines provenance-confidence states
   - lists the major earlier idea families
   - records the archive search queue
   - prevents retroactive over-attribution

2. [Provenance Evidence Register](provenance_evidence_register.md)
   - links evidence labels to founder confirmation, archive artifacts, repository commits, and source maps
   - distinguishes mapped research from references still awaiting direct source pointers
   - records public privacy and promotion rules

3. [Smart Stereo Origin Lineage](smart_stereo_origin_lineage.md)
...
It should also not assign an outside origin merely because similar work exists.
...
origin state
  -> surviving evidence
  -> direct source claim, when confirmed
  -> limitation
  -> Velvet inference
  -> Adopt / Adapt / Reject
