...
- [`manufacturing_quality_system_baseline.md`](manufacturing_quality_system_baseline.md) — product identity, BOM/supplier control, build records, workmanship, production test, measurement, nonconformance/CAPA, safe launch, field returns, and recall-readiness baseline.
